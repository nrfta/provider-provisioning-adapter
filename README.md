...
The data being passed to the script is minified JSON string. The shape of the object differs between the CREATE/REMOVE scripts and MOD scripts - as seen below.
